    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ action('TipeController@store') }}" method="post">
                    @csrf
...
<div class="modal fade" id="deleteData" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('master/tipe') }}" method="post" id="deleteForm">
                    @method('DELETE')
                    @csrf
...
$(document).ready( function () {
    ...
    $(document).on('click', '.edit', function () {
        ...
        $('#editForm').attr('action','/master/tipe/'+id);
    });
    ...
    $('#deleteForm').attr('action','/master/tipe/'+id);
    });
});
</script>
@stop