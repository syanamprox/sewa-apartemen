...
@section('header')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('templates/plugins/dropify/dropify.min.css') }}">
    <link href="{{ asset('templates/assets/css/users/account-setting.css') }}" rel="stylesheet" type="text/css" />
    <!--  END CUSTOM STYLE FILE  -->
@stop

@section('footer')
    <!--  BEGIN CUSTOM SCRIPTS FILE  -->
    <script src="{{ asset('templates/plugins/dropify/dropify.min.js') }}"></script>
    <script src="{{ asset('templates/plugins/blockui/jquery.blockUI.min.js') }}"></script>
    <!-- <script src="{{ asset('templates/plugins/tagInput/tags-input.js')  }}"></script> -->
    <script src="{{ asset('templates/assets/js/users/account-settings.js')  }}"></script>
