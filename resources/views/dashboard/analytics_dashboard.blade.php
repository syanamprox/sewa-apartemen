...
<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
    <div class="widget widget-card-one">
        <div class="widget-content">
            ...
            <div class="media">
                <div class="w-img">
                    <img src="{{ ('templates/assets/img/90x90.jpg') }}" alt="avatar">
                </div>
...
@section('header')
<link href="{{ ('templates/assets/css/dashboard/dash_2.css') }}" rel="stylesheet" type="text/css" />
@stop

@section('footer')
<script src="{{ ('templates/assets/js/dashboard/dash_2.js') }}"></script>
@stop